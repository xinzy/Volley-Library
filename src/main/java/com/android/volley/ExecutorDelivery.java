...
public class ExecutorDelivery implements ResponseDelivery {
	...
	@Override
	public void postCancelled(final Request<?> request) {
		request.addMarker("post-cancelled");
		mResponsePoster.execute(new Runnable() {
			@Override
			public void run() {
				request.deliverCancelled();
			}
		});
	}

	@Override
	public void postLoading(final Request<?> request, final long total, final long current) {
		mResponsePoster.execute(new Runnable() {
			@Override
			public void run() {
				request.deliverLoading(total, current);
			}
		});
	}
