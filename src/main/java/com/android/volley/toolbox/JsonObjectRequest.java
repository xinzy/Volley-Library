...
public class JsonObjectRequest extends JsonRequest<JSONObject> {
	 ...
	 */
	public JsonObjectRequest(int method, String url, JSONObject jsonRequest, RequestCallback<JSONObject> callback) {
	 ...
	 *
	 * @see #JsonObjectRequest(int, String, JSONObject, RequestCallback)
	 */
	public JsonObjectRequest(String url, JSONObject jsonRequest, RequestCallback<JSONObject> callback) {
		this(jsonRequest == null ? Method.GET : Method.POST, url, jsonRequest, callback);
	}
