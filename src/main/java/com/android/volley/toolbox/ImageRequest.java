...
//	private final Response.Listener<Bitmap> mListener;
	...
	/**
	 * For API compatibility with the pre-ScaleType variant of the constructor. Equivalent to the normal constructor with
	 * {@code ScaleType.CENTER_INSIDE}.
	 */
	@Deprecated
	public ImageRequest(String url, int maxWidth, int maxHeight, Config decodeConfig, RequestCallback<Bitmap> callback) {
		this(url, maxWidth, maxHeight, ScaleType.CENTER_INSIDE, decodeConfig, callback);
	}
